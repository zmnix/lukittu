...
export function Sidebar() {
  ...
  return (
    <aside
      className={cn(
        'sticky left-0 top-0 z-20 h-screen shrink-0 -translate-x-full transform-gpu bg-background transition-[width] duration-300 ease-in-out max-lg:hidden lg:translate-x-0',
